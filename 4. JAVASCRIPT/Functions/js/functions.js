...
//function receives 8 digit numer and returns a single letter
...
//EXERCISE 2
//this exercise you have to do if else
// Uncomment the exercise code deleting /* and */ 
// Open the console and reload the index page to see the result of the code.
...
//EXERCISE 3 -->need help: Do you want me to return the number ?
...
function findLongestWord(array_words) {
	var sortWords = array_words.sort(function(a, b){  //sorted
        return b.length - a.length; // ASC -> a - b; DESC -> b - a
    });
	//console.log(sortWords [0]);
	var lengthWord = sortWords[0].length //obtained lenght
return lengthWord;
}
...
// Open the console and reload the index page to see the result of the code.
// -->You have to complete the calculateAverage function (it is a few lines below)
// -->You have to return the average of every number in a array 
//For this problem I used the previous functions
...
var array_lengths = [];
array_lengths.push( findLongestWord( ["Richie", "Joanie", "Juanita", "Greg", "Marcia", "Bobby"]) );
array_lengths.push( findLongestWord( ["Blanka", "Zangief", "Chun Li", "Guile"] ) );
array_lengths.push( findLongestWord( ["Red", "Blue", "Green"] ) );
array_lengths.push( findLongestWord( ["Cake", "Soda", "Chocolate", "Vanilla", "Tart", "Pizza", "Lasagna", "Bagels", "pasta"]) );

//added more length to the array
// Used this structure: array_lengths.push( findLongestWord( [<add some elements>] ) );
function calculateAverage(array) { // return the average of every number in an array
	var total = 0;
    	for(var i = 0; i < array_lengths.length; i++) {
        total += array_lengths[i]; }
	var avg = total / array_lengths.length
...
//the second part to this one came out false?
// Reload the page and see how changed the average; must come out TRUE!
*/
...
// Now we are going to save the longest length of every array in a new array called array_lengths
// Open the console and reload the index page to see the result of the code.
// --> Write a function charFreq() that:
//----> takes a string and builds a frequency listing of the characters contained in it. 
